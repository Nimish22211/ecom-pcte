...
function LandingPage() {
  return (
    <>
      <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-blue-300 to-slate-50">
        <h1 className=" text-6xl font-bold font-sans text-blue-600 mb-4">
          CampusCart
        </h1>
